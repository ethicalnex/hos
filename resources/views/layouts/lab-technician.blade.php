...
<nav class="navbar navbar-expand-md navbar-dark shadow">
    <div class="container-fluid">
        <a class="navbar-brand" href="{{ route('lab-technician.dashboard') }}">
            <i class="fas fa-flask me-2"></i>{{ auth()->user()->hospital->name }} Lab
        </a>
        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="height: calc(100vh - 56px);">
            <div class="position-sticky pt-3">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('lab-technician.dashboard') ? 'active' : '' }}" 
                           href="{{ route('lab-technician.dashboard') }}">
                            <i class="fas fa-home me-2"></i>Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('lab-technician.lab.results.*') ? 'active' : '' }} 
                           {{ !auth()->user()->hospital->hasFeature('lab') ? 'disabled' : '' }}"
                           href="{{ auth()->user()->hospital->hasFeature('lab') ? route('lab-technician.lab.results.index') : '#' }}">
                            <i class="fas fa-flask me-2"></i>Lab Results
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('lab-technician.appointments.*') ? 'active' : '' }}" 
                           href="{{ route('lab-technician.appointments.index') }}">
