...
<head>
    ...
    <title>@yield('title', 'Patient Portal') - {{ auth()->user()->hospital->name }}</title>
...
<nav class="navbar navbar-expand-md navbar-dark shadow">
    <div class="container-fluid">
        <a class="navbar-brand" href="{{ route('patient.home') }}">
            <i class="fas fa-procedures me-2"></i>{{ auth()->user()->hospital->name }}
        </a>
...
<nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="height: calc(100vh - 56px);">            <div class="position-sticky pt-3">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('patient.home') ? 'active' : '' }}" 
