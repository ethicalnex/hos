...
<head>
    ...
    <title>@yield('title', 'Pharmacy Dashboard')</title>
...
<nav class="navbar navbar-expand-md navbar-dark shadow">
    <div class="container-fluid">
        <a class="navbar-brand" href="{{ route('pharmacy.dashboard') }}">
        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="height: calc(100vh - 56px);">
            <div class="position-sticky pt-3">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('pharmacy.dashboard') ? 'active' : '' }}" 
                           href="{{ route('pharmacy.dashboard') }}">
                            <i class="fas fa-home me-2"></i>Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('pharmacy.dispense.*') ? 'active' : '' }} 
                           {{ !auth()->user()->hospital->hasFeature('pharmacy') ? 'disabled' : '' }}"
                           href="{{ auth()->user()->hospital->hasFeature('pharmacy') ? route('pharmacy.dispense.index') : '#' }}">
                            <i class="fas fa-box-open me-2"></i>Dispense Prescriptions
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('pharmacy.sales.*') ? 'active' : '' }}" 
                           href="{{ route('pharmacy.sales.index') }}">
                            <i class="fas fa-money-bill-wave me-2"></i>Sales
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('pharmacy.reports.*') ? 'active' : '' }}" 
