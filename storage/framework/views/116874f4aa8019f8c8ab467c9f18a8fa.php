...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Nurse Dashboard'); ?> - <?php echo e(auth()->user()->hospital->name); ?></title>
...
<nav class="navbar navbar-expand-md navbar-dark bg-primary shadow">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo e(route('nurse.dashboard')); ?>">
    <i class="fas fa-user-nurse me-2"></i>Nurse <?php echo e(auth()->user()->name); ?>
        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div class="position-sticky pt-3">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('nurse.dashboard') ? 'active' : ''); ?>" 
                           href="<?php echo e(route('nurse.dashboard')); ?>">
...
</html><?php /**PATH C:\wamp64\www\EthicalNex\resources\views/layouts/nurse.blade.php ENDPATH**/ ?>