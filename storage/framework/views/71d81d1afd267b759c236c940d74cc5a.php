...
<div class="container-fluid px-4">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
          <form method="POST" action="<?php echo e(route('super-admin.subscription-plans.update', $plan)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                               name="trial_days" value="<?php echo e(old('trial_days', $plan->trial_days)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="billing_cycle" required>
                            ...
                            <option value="monthly" <?php echo e(old('billing_cycle', $plan->billing_cycle) == 'monthly' ? 'selected' : ''); ?>>Monthly</option>
                            <option value="yearly" <?php echo e(old('billing_cycle', $plan->billing_cycle) == 'yearly' ? 'selected' : ''); ?>>Yearly</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>" 
                               name="max_staff" value="<?php echo e(old('max_staff', $plan->max_staff)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                               name="max_patients" value="<?php echo e(old('max_patients', $plan->max_patients)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                               name="max_departments" value="<?php echo e(old('max_departments', $plan->max_departments)); ?>" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="features[emr]" id="feature-emr" 
                                       <?php echo e(old('features.emr', $plan->features['emr']) ? 'checked' : ''); ?>>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="features[lab]" id="feature-lab" 
                                       <?php echo e(old('features.lab', $plan->features['lab']) ? 'checked' : ''); ?>>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="features[pharmacy]" id="feature-pharmacy" 
                                       <?php echo e(old('features.pharmacy', $plan->features['pharmacy']) ? 'checked' : ''); ?>>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="features[billing]" id="feature-billing" 
                                       <?php echo e(old('features.billing', $plan->features['billing']) ? 'checked' : ''); ?>>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="features[appointments]" id="feature-appointments" 
                                       <?php echo e(old('features.appointments', $plan->features['appointments']) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="features[reports]" id="feature-reports" 
                                       <?php echo e(old('features.reports', $plan->features['reports']) ? 'checked' : ''); ?>>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="features[ai]" id="feature-ai" 
                                       <?php echo e(old('features.ai', $plan->features['ai']) ? 'checked' : ''); ?>>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="features[mobile_app]" id="feature-mobile_app" 
                                       <?php echo e(old('features.mobile_app', $plan->features['mobile_app']) ? 'checked' : ''); ?>>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="features[sms]" id="feature-sms" 
                                       <?php echo e(old('features.sms', $plan->features['sms']) ? 'checked' : ''); ?>>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="features[api]" id="feature-api" 
                                       <?php echo e(old('features.api', $plan->features['api']) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('super-admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\EthicalNex\resources\views/super-admin/subscription-plans/edit.blade.php ENDPATH**/ ?>