...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="<?php echo e(route('super-admin.hospitals')); ?>" class="btn btn-secondary">
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="<?php echo e(route('super-admin.hospitals.store')); ?>">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                           id="country" name="country" value="<?php echo e(old('country', 'Nigeria')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
               id="admin_email" name="admin_email" value="<?php echo e(old('admin_email')); ?>" required
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" class="form-control <?php $__errorArgs = ['admin_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
               id="admin_password" name="admin_password" value="<?php echo e(old('admin_password', \Illuminate\Support\Str::password(12))); ?>" required
...
<?php echo $__env->make('super-admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\EthicalNex\resources\views/super-admin/hospitals/create.blade.php ENDPATH**/ ?>