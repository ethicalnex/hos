...
<?php $__env->startSection('title', 'Register as Patient - ' . $hospital->name); ?>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">at <?php echo e($hospital->name); ?></p>
                </div>
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('patient.register.store', $hospital->slug)); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                <input type="hidden" name="hospital_slug" value="<?php echo e($hospital->slug); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control <?php $__errorArgs = ['allergies'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    id="allergies" name="allergies" value="<?php echo e(old('allergies')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                    id="emergency_contact_name" name="emergency_contact_name" value="<?php echo e(old('emergency_contact_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                    id="emergency_contact_phone" name="emergency_contact_phone" value="<?php echo e(old('emergency_contact_phone')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="insurance_provider" name="insurance_provider" value="<?php echo e(old('insurance_provider')); ?>">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="insurance_number" class="form-label">Policy Number</label>
                                <input type="text" class="form-control" id="insurance_number" name="insurance_number" value="<?php echo e(old('insurance_number')); ?>">
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\EthicalNex\resources\views/patient/register.blade.php ENDPATH**/ ?>