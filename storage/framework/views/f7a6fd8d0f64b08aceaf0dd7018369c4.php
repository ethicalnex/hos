...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <?php if(auth()->check()): ?>
                            <div class="alert alert-success">
                                <i class="fas fa-user me-2"></i> Logged in as: <?php echo e(auth()->user()->name); ?> (<?php echo e(auth()->user()->role); ?>)
                            </div>
                        <?php else: ?>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $apiRoutes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <span class="method <?php echo e($route['method']); ?>">
                                                <?php echo e($route['method']); ?>

                                            </span>
                                        </td>
                                        <td><code class="endpoint"><?php echo e($route['uri']); ?></code></td>
    ...
    <script>
        document.getElementById('testForm').addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch('<?php echo e(route("api.test")); ?>', {
                    method: 'POST',
                    headers: {
...
</html><?php /**PATH C:\wamp64\www\EthicalNex\resources\views/api/documentation.blade.php ENDPATH**/ ?>